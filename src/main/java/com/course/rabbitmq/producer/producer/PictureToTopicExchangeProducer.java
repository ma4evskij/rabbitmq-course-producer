...
//@Service
public class PictureToTopicExchangeProducer {
    ...
    public void send(Picture picture) throws JsonProcessingException {
        var key = getKey(picture);
        rabbitTemplate.convertAndSend("x.picture", key, objectMapper.writeValueAsString(picture));
    }

    private String getKey(Picture picture) {
